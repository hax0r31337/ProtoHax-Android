package dev.sora.protohax.relay.ui.element.elements
...
import dev.sora.protohax.Client
import dev.sora.protohax.relay.MinecraftRelay.session
import dev.sora.protohax.relay.ui.element.Border
import dev.sora.protohax.relay.ui.element.Element
import dev.sora.protohax.relay.ui.element.ElementInfo
import dev.sora.protohax.relay.ui.element.Side
import dev.sora.protohax.util.ColorUtils
import dev.sora.relay.cheat.value.BoolValue
import dev.sora.relay.cheat.value.FloatValue
import dev.sora.relay.cheat.value.FontValue
