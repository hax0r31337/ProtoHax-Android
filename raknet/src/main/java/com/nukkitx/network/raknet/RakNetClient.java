...
public class RakNetClient extends RakNet {
    ...
    public RakNetClientSession connect(InetSocketAddress address) {
        ...
        this.session = new RakNetClientSession(this, address, this.channel, this.channel.eventLoop(), MAXIMUM_MTU_SIZE, this.protocolVersion);
        return this.session;
    }
    ...
    public static class PingEntry {
        ...
        public PingEntry(final CompletableFuture<RakNetPong> future, final long timeout) {
            this.future = future;
    ...
    public static class PongEntry {
        ...
        @java.lang.SuppressWarnings("all")
        public PongEntry(final InetSocketAddress address, final long pingTime, final long guid, final byte[] userData) {
